...
# JWT — generate strong secrets at https://generate-secret.vercel.app/64
JWT_ACCESS_SECRET=<strong-random-64-char-secret>
JWT_REFRESH_SECRET=<strong-random-64-char-secret>
...
FROM_EMAIL=noreply@wearhaus.com
...
# Company details (used on PDF invoices)
COMPANY_NAME=Wearhaus
COMPANY_ADDRESS=123, Business Park, Mumbai
COMPANY_CITY_STATE_PIN=Maharashtra, India - 400001
COMPANY_GSTIN=27XXXXX1234X1Z5
COMPANY_EMAIL=support@wearhaus.com
COMPANY_PHONE=+91 9876543210

# Admin seed (first admin account — change these before deploying)
ADMIN_NAME=Super Admin
ADMIN_EMAIL=admin@wearhaus.com
